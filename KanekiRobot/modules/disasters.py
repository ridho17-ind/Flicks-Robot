...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "KanekiRobot/elevated_users.json")
...
# *Global Blue Text*
#  /gignoreblue*:* <word>*:* Globally ignorea bluetext cleaning of saved word across KanekiRobot.
